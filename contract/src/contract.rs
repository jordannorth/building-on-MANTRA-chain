// This is a conditional compilation directive that tells the compiler to only include entry_point when it is a library.
...
// Set as &str as we known they won't change
